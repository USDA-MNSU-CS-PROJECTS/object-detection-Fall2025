...
-   **Key Functions:**
    ...
    -   `run_full_pipeline(files, conf_threshold, save_overlays)`: Manages the "Full Analysis Pipeline," which includes image conversion, model prediction, post-processing, and generating CSV reports and overlay images.
-   **Model Configuration:** The `DEFAULT_MODEL_FILENAME` variable at the top of this file allows easy switching of the trained YOLO model used for predictions.
...
-   **Purpose:** Responsible for converting ND2 microscopy image files into PNG format.
-   **Key Functions:**
